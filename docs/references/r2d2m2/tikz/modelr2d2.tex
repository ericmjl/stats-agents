\begin{tikzpicture}
    ...
    \node[state] (phip) at (4,1) {$\phi_p$};


    \node[state] (phip1) at (4,-1)  {$\phi_{p+1}$};
    ...
    \node[state] (lambdap) at (6,1) {$\lambda_p$};


    \node[state] (lambdap1) at (6,-1) {$\lambda_{p+1}$};
    ...
    \node[state] (betap) at (8,1) {$b_p$};

    \node[state] (u11) at (8,-1)  {$u_{11}$};
    \node[hmissing] (hdots1) at (9,-1) {};
    \node[vmissing] (dots8) at (8,-2) {};
    \node[state] (ul1) at (10,-1)  {$u_{l1}$};
    ...
    \node[draw=blue,dotted, thick,fit=(beta1)(betap), inner sep=0.2cm] (bluebox) {};


    \node[draw=red,dotted,thick,fit=(u11)(ulq), inner sep=0.2cm] (redbox) {};
